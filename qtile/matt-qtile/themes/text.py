...
colors, backgroundColor, foregroundColor, workspaceColor, chordColor = colors.black()
...
group_labels = ["www", "todo", "term", "mail", "gimp", "obs", "audio", "files", "social", "music", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen"]
...
clockicon = widget.TextBox(text = "", fontsize = 20, font = "JetBrainsMono Nerd Font Mono", background = colors[2], foreground = colors[0])
clock = widget.Clock(format='%I:%M %p', font = "JetBrainsMono Nerd Font", padding = 10, background = colors[2], foreground = colors[0])
curlayout = widget.CurrentLayoutIcon(scale = 0.5, foreground = colors[2], background = colors[0], padding = 10,)
tray = widget.Systray(background = colors[0])
windowname = widget.WindowName(font="JetBrainsMono Nerd Font", foreground=colors[2], background=colors[0])

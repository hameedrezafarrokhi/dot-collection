...
music = widget.Mpris2(format = "{xesam:title} by {xesam:artist}", paused_text = "󰏤", max_chars = 20, foreground = colors[2], background = colors[0])
musicon = widget.TextBox(text = "󰝚", fontsize = 20, font = "JetBrainsMono Nerd Font Mono", background = colors[0], foreground = colors[3])
